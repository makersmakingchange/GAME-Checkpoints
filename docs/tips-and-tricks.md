...
<div class="center-thumb">
    <img src="../images/xbox-to-ps5.png" alt="an xbox controller beside a playstaition controller with color coded arrows showing the differnce in placement. A goes to cross, B goes to circle, Y goes to triangle, and X goes to square.">
